...
DROPSEQ_PIPELINE_DIR="$HOME/dropseqpipeline/"
DROP_SEQ_TOOLS="$HOME/drop-seq_tools/"
DROPSEQ_jar="$HOME/drop-seq_tools/jar/dropseq.jar"
...
SAMTOOLS_DIR="$HOME/TOOLS/samtools/"
SAMTOOLS="$SAMTOOLS_DIR/samtools/bin/samtools"
INPUTFOLDER="/media/ga94rac/DISK2/RAD_SEQUENCING/180221_NB501802_0048_AHJTTHBGX5"
OUTPUTFOLDER="$SCRATCH/180221/dropseq_out"
TEMP_FILES_PATH="$SCRATCH/180221/dropseq_tmp"
READ_1_LEN=75
READ_2_LEN=17
####################### annotations
# MOUSE
...
GENOME_path="$HOME/GENOME/gencode/release_29/mouse/" # local storage address
